namespace SierpinskiTriangle.Presenters.Graph.Drawing
{
    ...
    public class RightAngledToRightDrawing : RightAngledPatternBase<BigInteger>
    {
        #region Constructors and Destructors

        public RightAngledToRightDrawing(GraphPane pane, IList<BigInteger> sequence, IList<bool> visData)
